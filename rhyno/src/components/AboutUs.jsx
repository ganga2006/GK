...
function AboutUs() {
  return (
    <div>
      <h1>ABOUT US</h1>
        <p style={{fontSize:'17px'}}>Established in 2019 by an automotive engineer with a vision for sustainable and robust
...
believe in engineering solutions that solve problems.</p>
        <p style={{fontSize:'17px'}}>With our first product, we've taken a bold step to create something more than just a vehicle;
